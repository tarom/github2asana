...
issues =
  if CONFIG['github']['milestone_id']
    octokit.list_issues("#{CONFIG['github']['name']}/#{CONFIG['github']['repos']}", milestone: CONFIG['github']['milestone_id'])
  else
    octokit.list_issues("#{CONFIG['github']['name']}/#{CONFIG['github']['repos']}")
  end
